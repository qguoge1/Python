...
## version: avec classe trajet: generation aleatoire du trajet + calcul de distance : pour 4 villes
...
## version: generation aleatoire du trajet + calcul de distance : pour N villes
...
class trajet():
    ...
    def __init__(self, nom_t,liste_ville):
        self.nom_ville=nom_t
        self.liste= liste_ville
        self.nb_villes=int(input("combien de villes?"))
